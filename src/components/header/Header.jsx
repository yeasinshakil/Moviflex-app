...
const Header = () => {
    ...
    return (
        <div className={` h-[60px] w-full flex items-center bg-black/25 backdrop-blur-md relative ${mobileMenu ? ' bg-black3' : ''}`}>
            <ContentWrapper>
                <div className=' flex items-center justify-between'>
                    ...
                    <div>
                        ...
                        <span className={`cursor-pointer ${mobileMenu? 'text-[20px] w-full h-auto py-[15px]  px-[20px] m-0 flex flex-col items-start' : ''}`}>
                            <HiOutlineSearch />
                        </span>
                    </div>
